            ...
            <div className="max-w-7xl mx-auto px-6 pt-10">
                <GlassCard className="mb-10 animate-fade-in" hover={false}>
                    <header className="flex flex-col md:flex-row justify-between items-center gap-6 p-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-black text-white uppercase tracking-tight">Mentor Dashboard</h1>
                                <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.2em]">Mentor: {user?.name}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            ...
                            <Link
                                to="/resignation"
                                className="text-xs font-black uppercase tracking-widest text-gray-500 hover:text-yellow-500 transition-colors"
                            >
                                Leave Dashboard
                            </Link>
                            <Button
                ...
                <div className="flex gap-4 mb-8">
                    <button
                        ...
                        className={`text-[10px] font-black uppercase tracking-[0.2em] px-6 py-3 rounded-xl transition-all border ${activeTab === 'browse' ? 'bg-space-light/10 text-space-light border-space-light/30 shadow-[0_0_20px_rgba(0,240,255,0.15)]' : 'bg-white/5 text-gray-500 border-white/5 hover:border-white/10 hover:text-white'}`}
                    >
                        Available Courses
                    </button>
                    <button
                        onClick={() => setActiveTab('classrooms')}
                        className={`text-[10px] font-black uppercase tracking-[0.2em] px-6 py-3 rounded-xl transition-all border ${activeTab === 'classrooms' ? 'bg-space-light/10 text-space-light border-space-light/30 shadow-[0_0_20px_rgba(0,240,255,0.15)]' : 'bg-white/5 text-gray-500 border-white/5 hover:border-white/10 hover:text-white'}`}
                    >
                        My Classes ({Array.isArray(myClassrooms) ? myClassrooms.length : 0})
                    </button>
                </div>

                <GlassCard className="min-h-[600px] animate-scale-in" hover={false}>
                    <div className="p-4">
                        {activeTab === 'browse' && (
                                                            ...
                                                            <div className="mt-4 pt-4 border-t border-white/5 flex justify-between items-center">
                                                                <div className="text-xs text-gray-400">
                                                                    {selectedClassroom.quizzes?.some(q => q.moduleIndex === mIndex) ?
                                                                        ...
                                                                        <span className="text-yellow-500/80">⚠ No Quiz Added</span>
                                                                    }
                                                                </div>
                                                                <button
                                                                    onClick={() => {
